...
#тестовые сценарии для еще незарегистрированных пользователей с последующей регистрацией
class TestNewUserAddToBasketFromProductPage():
    @pytest.fixture(scope="function", autouse=True)
    def setup(self, browser):
        link = "http://selenium1py.pythonanywhere.com/en-gb/accounts/login/"
        login_page = LoginPage(browser, link)
        login_page.open()
        login_page.register_new_user(email=True, password=True, password_confirm=True)
